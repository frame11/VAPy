...
class VAPyTests(unittest.TestCase):
    ...
    def test_get_invalid_submission_content(self):
        self.assertEqual(self.vapy.get_submission_content(self.vapy.submission_dict_from_id(99999999)), {})
    ...
    def test_get_invalid_submission_subverse(self):
        self.assertEqual(self.vapy.get_submission_subverse(self.vapy.submission_dict_from_id(99999999)), {})
    ...
    def test_get_invalid_submission_author(self):
        self.assertEqual(self.vapy.get_submission_author(self.vapy.submission_dict_from_id(99999999)), {})
    ...
    def test_get_invalid_submission_scores(self):
        self.assertEqual(self.vapy.get_submission_scores(self.vapy.submission_dict_from_id(99999999)), {})
    ...
    def test_get_invalid_submission_score(self):
        self.assertEqual(self.vapy.get_submission_score(self.vapy.submission_dict_from_id(99999999)), {})
    ...
    def test_get_invalid_submission_date(self):
        self.assertEqual(self.vapy.get_submission_date(self.vapy.submission_dict_from_id(99999999)), {})
